...
<body>
<script>
    alert("You don't have a account please SignIn")
</script>
<%
...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="login-box col-12 col-md-6 col-lg-4">
        ...
        <form action="signInRequest" method="post">
        ...
        <%--        <p class="text-center mt-4 signup-text">Don't have an account? <a href="signInRequest">Sign Up</a></p>--%>
    </div>
</div>
